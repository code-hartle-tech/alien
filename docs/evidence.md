...
| Keyboard backlight timeout | **Unsupported here** | The only proven getter returns firmware status `0xe2` |
| Battery charge limiter | **Unsupported here** | Sub-index rejected on this model |
| Per-key colour | **Experimental** | ITE 8291 transport exists, no hardware validation |
