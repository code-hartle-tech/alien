...
impl Support {
    pub fn symbol(self) -> &'static str {
        match self {
            Support::Yes => "yes",
            Support::No => "no",
            // Not "unverified": the call IS verified — the firmware takes it
            // and the readback agrees. What is unconfirmed is whether the
            // hardware does anything observable, which is a fact about the
            // hardware, not a doubt about this code.
            Support::Unverified => "effect unmeasured",
