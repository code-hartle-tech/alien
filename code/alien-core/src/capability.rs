...
///
/// Every field is [`Support::Unverified`], which is the literally true answer
...
impl Default for Capabilities {
    fn default() -> Self {
        Capabilities {
            cpu_temp: Support::Unverified,
            gpu_temp: Support::Unverified,
            system_temp: Support::Unverified,
            cpu_fan: Support::Unverified,
            gpu_fan: Support::Unverified,
            fan_control: Support::Unverified,
            manual_fan_duty: Support::Unverified,
            backlight_effects: Support::Unverified,
            per_zone_static: Support::Unverified,
            per_key: Support::Unverified,
            cpu_overclock: Support::Unverified,
            gpu_overclock: Support::Unverified,
